...
Before this table, follow §1.1's General-side `munsu task add` and `munsu brief` steps: `munsu captain handoff` transfers an existing queued, source-owned canonical task from the General home and does not create it.
