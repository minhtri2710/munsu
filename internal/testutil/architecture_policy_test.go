...
func TestTransitionalPackagePolicy(t *testing.T) {
	...
	retired := map[string]bool{"session": true, "worktree": true, "hometag": true, "ghurl": true, "glurl": true, "composer": true, "nostatus": true, "event": true, "mailbox": true, "uplink": true, "wakedelivery": true, "waker": true, "turnend": true, "afk": true}
