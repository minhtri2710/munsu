...
func TestPackageTopology(t *testing.T) {
	...
	allowed := map[string]bool{"domain": true, "backend": true, "orchestrator": true, "fleet": true, "config": true, "configmigration": true, "home": true, "harness": true, "bootstrap": true, "testutil": true, "cli": true, "taskauthority": true, "taskauthorityfs": true}
