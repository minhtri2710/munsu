...
func TestKnownKeys(t *testing.T) {
	known := KnownKeys
	expected := []string{"backend", "soldier-harness", "captain-harness", "model", "backlog-backend", "default-mode", "require-no-mistakes", "afk-digest-window", "afk-wedge-stale-beat", "afk-wedge-max-repeat", "afk-max-defer", "install-root"}
