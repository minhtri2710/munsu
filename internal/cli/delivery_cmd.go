...
func newReviewDiffCmd() *cobra.Command {
	return &cobra.Command{
		Use:   "review-diff <id>",
		Short: "Review diff between crew branch and base",
		Long: `Compare the crew branch against the authoritative base and print
...
func newMergeLocalCmd() *cobra.Command {
	return &cobra.Command{
		...
		Long: `Fast-forward merge the crew branch into the local default branch.
