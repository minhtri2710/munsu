...
with no requirement to live inside a firstmate checkout.`,
	...
	root.AddCommand(newReviewDiffTopCmd())
	root.AddCommand(newPRCheckTopCmd())
	root.AddCommand(newPRMergeTopCmd())
	root.AddCommand(newMergeLocalTopCmd())
	root.AddCommand(newFleetCmd())
	root.AddCommand(newFleetSyncTopCmd())
	root.AddCommand(newFleetSnapshotTopCmd())
	root.AddCommand(newFleetViewTopCmd())
	root.AddCommand(newBearingsTopCmd())
