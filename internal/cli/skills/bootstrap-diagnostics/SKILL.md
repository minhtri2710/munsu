...
When the bootstrap diagnostics section prints lines like `MISSING: <tool>`, `NEEDS_GH_AUTH`, `TANGLE:`, `SOLDIER_HARNESS:`, `SOLDIER_DISPATCH:`, `FLEET_SYNC:`, `SECOND_SYNC:`, `SECOND_LIVENESS:`, or `TASKS_AXI:`, consult `docs/skills/bootstrap-diagnostics.md` for the full handling playbook.
