...
func TestRecoverTransaction_DeadLaunchedRelaunches(t *testing.T) {
	...
	tx := &RecoverTransaction{Capabilities: RecoverCapabilities{Launch: testLaunchEndpoint{}, Nudge: &testNudgeEndpoint{result: NudgeResult{Status: "submitted", Acknowledged: true}}, Probe: &testProbeEndpoint{result: ProbeResult{PaneAlive: false, AgentAlive: false}}}}
