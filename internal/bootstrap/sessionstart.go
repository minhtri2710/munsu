...
func RunSessionStartWithWatcher(w io.Writer, home string, ensure WatchEnsureFunc, captainLiveness CaptainLivenessFunc, reclaim ReclaimTaskDataDir) (*SessionStartResult, error) {
